...
class details_popular extends StatefulWidget {
  get_popular_data detail;
  details_popular({required this.detail});

  @override
  State<details_popular> createState() => _details_popularState();
}

class _details_popularState extends State<details_popular> {
  List<String> value = [];
                      ...
                      Container(
                        ...
                        child: MaterialButton(
                          ...
                          onPressed: () {
                            ...
                            storage_shared.Store_Data(data);
